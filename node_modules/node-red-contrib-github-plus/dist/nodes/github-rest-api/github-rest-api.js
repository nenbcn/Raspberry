...
const nodeInit = (RED) => {
    function GithubRestApiNodeConstructor(config) {
        ...
        this.on("input", async (msg, send, done) => {
            ...
            const mediaType = config.mediaType || msg.mediaType || "application/vnd.github.v3+json";
...
//# sourceMappingURL=github-rest-api.js.map